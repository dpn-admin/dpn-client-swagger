...
# Unit tests for SwaggerClient::IngestApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IngestApi' do
  before do
    # run before each test
    @instance = SwaggerClient::IngestApi.new
  end
  ...
  describe 'test an instance of IngestApi' do
    it 'should create an instact of IngestApi' do
      expect(@instance).to be_instance_of(SwaggerClient::IngestApi)
    end
  end

  # unit tests for ingest_get
  ...
  describe 'ingest_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for ingest_post
  # Create an ingest
